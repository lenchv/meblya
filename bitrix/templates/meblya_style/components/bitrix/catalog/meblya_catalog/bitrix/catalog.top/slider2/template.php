...
?>
			...
			<div id="recently-viewed">
				<div class="recently-viewed-title">
					<div class="title-middle-text" style="width: 400px">
						<div>Хиты продаж</div>
						<div>раздела "Офис"</div>
					</div>
	...
	?>
							...
							<div class="item">
								<div class="item-name">
									...
									<span class="item-article">(артикул)</span>
								</div>
								<div class="reviews">
									отзывы:<span class="count-reviews">13</span>
								</div>
								<div class="item-availability">есть на складе</div>
								<img src="../../img/item1.png" alt="">
								<div class="item-price">
									<div class="price-old">1234,00 грн.</div>
									<div class="price-new">1234,00 грн.</div>
									<a href="#">
	...
	?>
				...
				<div class="all-views"><a href="#">Все просмотренные</a></div>
			</div>
