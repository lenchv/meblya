...
echo $arResult['NavRecordCount'];
echo "#";
echo $arResult['NavFirstRecordShow'];
echo "#";
echo $arResult['NavLastRecordShow'];
?>
<div class="pages-container">
	...
	<?if ($arResult["bShowAll"]):
		if ($arResult["NavShowAll"]):?>
			<a class="all-items" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=0">Смотреть постранично</a>
		<?else:?>
			<a class="all-items" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>SHOWALL_<?=$arResult["NavNum"]?>=1">Смотреть все товары</a>
		<?endif;
	endif?>
</div>