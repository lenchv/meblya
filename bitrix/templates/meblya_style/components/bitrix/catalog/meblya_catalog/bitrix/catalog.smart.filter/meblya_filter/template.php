...
?>
<?$this->SetViewTarget("options_area");?>
<div class="bx_filter <?=$templateData["TEMPLATE_CLASS"]?>">
	<div class="bx_filter_section">
		<div class="bx_filter_title">
			...
			<div class="expand-all" onclick="smartFilter.hideAllFilterProps(this)">Свернуть всё</div>
		</div>
			...
			foreach($arResult["ITEMS"] as $key=>$arItem)
			{
				...
				if(isset($arItem["PRICE"])):
					...
					<div class="bx_filter_parameters_box active">
						<?//AJAX подсказка, выводит информацию по свойству?>
						<!--span class="bx_filter_container_modef"></span-->
						<div class="bx_filter_parameters_box_title" onclick="smartFilter.hideFilterProps(this)"><?echo GetMessage("CT_BCSF_PRICE")?></div>
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<div class="bx_ui_slider_track" id="drag_track_<?=$key?>">
									...
									<div class="bx_ui_slider_part p1"></div>
									...
									<div class="bx_ui_slider_part p5"></div>
									<div class="to-price">
										<span>До<br /></span>
										<span class="max-price"><?=$price5?></span>
									</div>
									<div class="from-price">
										<span>От<br /></span>
										<span class="min-price"><?=$price1?></span>
									</div>
								</div>
					...
					$arJsParams = array(
						...
						"toPriceSelector" => ".to-price>.max-price",
						"fromPriceSelector" => ".from-price>.min-price",
					);
					?>
...
<?$this->EndViewTarget("options_area");?>
